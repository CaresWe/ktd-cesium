...
- **📖 文档部署**: 推送到 `main` 分支时自动构建并部署文档到 GitHub Pages
- **🔍 代码质量**: 每次提交都会运行类型检查、代码格式化和测试
- **📦 自动发布**: 支持手动触发发布到 NPM，支持语义化版本
- **🛡️ 安全检查**: 依赖审查和漏洞扫描
...
2. 选择 "Release" 工作流
3. 点击 "Run workflow"
4. 选择发布类型：`patch`、`minor`、`major` 或 `prerelease`
...
项目使用 [release-it](https://github.com/release-it/release-it) 进行自动化发布：
