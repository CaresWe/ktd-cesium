...
```typescript
import { clamp } from '@ktd-cesium/shared'
...
```typescript
import { lerp } from '@ktd-cesium/shared'
...
```typescript
import { random } from '@ktd-cesium/shared'
...
```typescript
import { randomInt } from '@ktd-cesium/shared'
...
```typescript
import { mapRange, lerpColor, hexToColor } from '@ktd-cesium/shared'
...
```typescript
import { random, randomInt } from '@ktd-cesium/shared'
...
```typescript
import { lerp, clamp } from '@ktd-cesium/shared'
